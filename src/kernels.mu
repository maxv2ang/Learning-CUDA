...
// ============================================================================
// FlashAttention-1 style online softmax (see kernels.cu for a full comment).
// Grid :  (target_seq_len, batch_size, query_heads); block = 128 threads,
// one query row t per block; dot phase (thread = source) + accum phase
// (thread = output dim), so each acc[d] is written by exactly one thread.
template <typename T>
...
// ============================================================================
// Host wrappers (Moore MUSA runtime)
// ============================================================================
template <typename T>
